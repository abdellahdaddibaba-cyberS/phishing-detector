  ...
  <div class="page" style="max-width:640px;">
    <div class="card">
      ...
      <p style="font-size:12px;color:var(--text3);margin-bottom:14px;line-height:1.6;">
        These sliders control how many points each detection vector adds to the final risk score (0–100).
        Raising a weight makes that signal more influential — e.g. setting URL weight to 60 means a single
        VirusTotal-confirmed malicious link pushes the score to 60 before any keyword checks.
        Lower a weight if you find that vector producing too many false positives in your environment.
      </p>
      ...
      <div class="slider-row">
        <div class="slider-label">Malicious URL (VirusTotal)</div>
      ...
      <div style="font-size:12px;font-family:var(--mono);color:var(--text3);margin-top:4px;">
        Total weight: <span id="total-weight" style="color:var(--accent);">${s.lingWeight+s.urlWeight}</span>
      </div>
    </div>
    ...
    <div class="card" style="margin-top:16px;">
      ...
      <p style="font-size:12px;color:var(--text3);margin-bottom:14px;line-height:1.6;">
        Thresholds define where the score boundaries fall between <strong style="color:var(--safe)">Safe</strong>,
        <strong style="color:var(--warn)">Suspicious</strong>, and
        <strong style="color:var(--danger)">Phishing</strong>.
        Default: 0–30 Safe · 31–70 Suspicious · 71–100 Phishing.
        Raise the Suspicious Threshold if too many safe emails get flagged as suspicious.
        Raise the Phishing Threshold if you want stricter confirmation before marking something as phishing.
      </p>
      <div class="two-col">
    ...
    <div class="card" style="margin-top:16px;">
      ...
      <div class="about-card">
        ...
        <br>
        A frontend interface for the MDP Project. Analyzes messages for phishing indicators across two vectors: <strong>linguistic patterns</strong> (urgency, fear, authority) and <strong>URL anomalies</strong> (confirmed via VirusTotal API).<br>
        <br>
